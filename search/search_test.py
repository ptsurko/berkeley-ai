...
from romania_search_problem import RomaniaSearchProblem, RomaniaMultipleCitiesSearchProblem, create_heuristic_to
...
class TestSearch(unittest.TestCase):
    ...
    def test_hill_climbing(self):
        problem = ChessProblem([1, 1, 1, 1])

        self.assertTrue(valid_chess_board(hill_climbing(problem)))
